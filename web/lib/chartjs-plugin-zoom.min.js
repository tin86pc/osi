...
!(function (e, o) {
  ...
  function s(e, o, n, a) {
    if (o.enabled && o.overScaleMode) {
      var i = (function (e, o, t) {
          for (var n = e.scales, a = Object.keys(n), i = 0; i < a.length; i++) {
            var r = n[a[i]];
            if (t >= r.top && t <= r.bottom && o >= r.left && o <= r.right)
              return r;
          }
          return null;
        })(e, n, a),
        r =
          "function" == typeof o.overScaleMode
            ? o.overScaleMode({ chart: e }, i)
            : o.overScaleMode;
      if (i && m(r, i.isHorizontal() ? "x" : "y", e)) return [i];
      var l = [];
      return (
        t.each(e.scales, function (o) {
          m(r, o.isHorizontal() ? "x" : "y", e) || l.push(o);
        }),
        l
      );
    }
  ...
  function d(e, o, t, n) {
    var a = e.max - e.min,
      i = a * (o - 1),
      r = e.isHorizontal() ? t.x : t.y,
      l = (e.getValueForPixel(r) - e.min) / a,
      m = i * l,
      s = i * (1 - l);
    (e.options.ticks.min = u(n, e.min + m)),
      (e.options.ticks.max = c(n, e.max - s));
  }
  function p(e, o, t, n) {
    var i = a[e.type];
    i && i(e, o, t, n);
  }
  function f(e, o, n, a, i, r) {
    var c = e.chartArea;
    a || (a = { x: (c.left + c.right) / 2, y: (c.top + c.bottom) / 2 });
    var u = e.$zoom._options.zoom;
    if (u.enabled) {
      l(e);
      var d,
        f = "function" == typeof u.mode ? u.mode({ chart: e }) : u.mode;
      d = "xy" === f && void 0 !== i ? i : "xy";
      var v = s(e, u, a.x, a.y);
      t.each(e.scales, function (t) {
        (v && -1 === v.indexOf(t)) ||
          (t.isHorizontal() && m(f, "x", e) && m(d, "x", e)
            ? ((u.scaleAxes = "x"), p(t, o, a, u))
            : !t.isHorizontal() &&
              m(f, "y", e) &&
              m(d, "y", e) &&
              ((u.scaleAxes = "y"), p(t, n, a, u)));
      }),
        r ? e.update({ duration: r, easing: "easeOutQuad" }) : e.update(0),
        "function" == typeof u.onZoom && u.onZoom({ chart: e });
    }
  }
  function v(e, o, n) {
    var a,
      ...
      r = e.min,
      l = e.max,
      m = e.getValueForPixel(e.getPixelForValue(r) - o),
      s = e.getValueForPixel(e.getPixelForValue(l) - o),
      c = (m = m.valueOf ? m.valueOf() : m),
    ...
    n.scaleAxes &&
      ...
      m >= c && s <= u
        ? ((i.min = m), (i.max = s))
        : m < c
        ? ((a = r - c), (i.min = c), (i.max = l - a))
        : s > u && ((a = u - l), (i.max = u), (i.min = r + a));
  }
  function h(e, o, t) {
    var n = i[e.type];
    n && n(e, o, t);
  ...
  (e.Zoom.defaults = e.defaults.global.plugins.zoom =
    ...
    (n.zoomFunctions.category = function (e, o, t, a) {
      ...
      (n.zoomCumulativeDelta =
        ...
        Math.abs(n.zoomCumulativeDelta) > s &&
          (n.zoomCumulativeDelta < 0
            ...
            : n.zoomCumulativeDelta > 0 &&
              (p >= d
                ? (r = r < m ? (r = Math.min(m, r + 1)) : r)
                : p < d && (m = m > r ? (m = Math.max(r, m - 1)) : m),
              (n.zoomCumulativeDelta = 0)),
          (e.options.ticks.min = u(a, i[r])),
          (e.options.ticks.max = c(a, i[m])));
    }),
    ...
    (n.zoomFunctions.linear = d),
    (n.zoomFunctions.logarithmic = d),
    (n.panFunctions.category = function (e, o, t) {
      var a,
        i = e.chart.data.labels,
        r = i.length - 1,
        l = Math.max(e.ticks.length, 1),
        m = t.speed,
        s = e.minIndex,
        d = Math.round(e.width / (l * m));
      (n.panCumulativeDelta += o),
        (s =
          n.panCumulativeDelta > d
            ...
            ? Math.min(r - l + 1, s + 1)
            : s),
        (n.panCumulativeDelta = s !== e.minIndex ? 0 : n.panCumulativeDelta),
        (a = Math.min(r, s + l - 1)),
        (e.options.ticks.min = u(t, i[s])),
        (e.options.ticks.max = c(t, i[a]));
    }),
    ...
    (n.panFunctions.linear = v),
    (n.panFunctions.logarithmic = v),
  ...
  var x = {
    ...
    beforeInit: function (e, a) {
      ...
      r(e, a);
      var c = e.$zoom._options,
        u = c.pan && c.pan.threshold;
        ...
        (e.$zoom._mouseUpHandler = function (o) {
          if (e.$zoom._dragZoomStart) {
            ...
            var t = e.$zoom._dragZoomStart,
              ...
              r = Math.max(t.clientX, o.clientX) - n,
              l = t.target.getBoundingClientRect().top,
              s = Math.min(t.clientY, o.clientY) - l,
              u = r - a,
              d = Math.max(t.clientY, o.clientY) - l - s;
            (e.$zoom._dragZoomStart = null), (e.$zoom._dragZoomEnd = null);
            var p = (c.zoom && c.zoom.threshold) || 0;
            if (!(u <= p && d <= p)) {
              var v = e.chartArea,
                h = e.$zoom._options.zoom,
                x = v.right - v.left,
                g = m(h.mode, "x", e) && u ? 1 + (x - u) / x : 1,
                z = v.bottom - v.top,
                y = m(h.mode, "y", e);
              f(
                e,
      ...
      if (
        ...
        var p,
          v = new o.Manager(i);
        v.add(new o.Pinch()), v.add(new o.Pan({ threshold: u }));
        var x = function (o) {
          var t = (1 / p) * o.scale,
            ...
            r = Math.abs(o.pointers[0].clientY - o.pointers[1].clientY),
            l = i / r;
          f(e, t, t, a, l > 0.3 && l < 1.7 ? "xy" : i > r ? "x" : "y");
          var m = e.$zoom._options.zoom;
          "function" == typeof m.onZoomComplete &&
            m.onZoomComplete({ chart: e }),
            (p = o.scale);
        };
        v.on("pinchstart", function () {
          p = 1;
        }),
          v.on("pinch", x),
          v.on("pinchend", function (e) {
            x(e), (p = null), (n.zoomCumulativeDelta = 0);
          });
        var g = null,
          z = null,
          y = !1,
          ...
          M = function (o) {
            if (null !== g && null !== z) {
              ...
              (g = o.deltaX),
                ...
                (function (e, o, n, a) {
                  l(e);
                  var i = e.$zoom._options.pan;
                  if (i.enabled) {
                    var r =
                      "function" == typeof i.mode
                        ? i.mode({ chart: e })
                        : i.mode;
                    t.each(e.scales, function (t) {
                      (a && -1 === a.indexOf(t)) ||
                        (t.isHorizontal() && m(r, "x", e) && 0 !== o
                          ? ((i.scaleAxes = "x"), h(t, o, i))
                          : !t.isHorizontal() &&
                            m(r, "y", e) &&
                            0 !== n &&
                            ((i.scaleAxes = "y"), h(t, n, i)));
                    }),
                      e.update(0),
                      "function" == typeof i.onPan && i.onPan({ chart: e });
                  }
                })(e, n, a, _);
            }
          };
        v.on("panstart", function (o) {
          var t = e.$zoom._options.pan;
          if (t.enabled) {
    ...
    beforeDatasetsDraw: function (e) {
      ...
      if (e.$zoom._dragZoomEnd) {
        var t = (function (e) {
          ...
          s = n.top,
          c = n.bottom;
        if (m(e.$zoom._options.zoom.mode, "x", e)) {
          var u = a.target.getBoundingClientRect().left;
          (r = Math.min(a.clientX, i.clientX) - u),
            (l = Math.max(a.clientX, i.clientX) - u);
        }
        if (m(e.$zoom._options.zoom.mode, "y", e)) {
